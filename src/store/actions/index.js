import Vue from 'vue'
import {GET_POPULAR_MOVIES, GET_DETAIL_MOVIE, GET_SIMILAR_MOVIE, ADD_TO_FAVORITES, REMOVE_FROM_FAVORITES, 
    NOW_IN_THE_CINEMA, CHECK_USER, LOGOUT, GET_FAVORITES, START, SUCCESS, FAIL} from '../../constants'
